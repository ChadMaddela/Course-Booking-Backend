...
- Verify will be used as a middleware in Express.JS. Functions added as argument in an expressJS route are considered as middleware and is able to receive the request and response objects as well as the next () function. Middlewares will be further elaborated on later sessions
*/
...
module.exports.verifyAdmin = (req, res, next) => {
	...
	if(req.user.isAdmin){
		...
		return res.status(403).send({ auth : "Failed", message: "You do not have rights to do this"})
	}
}
